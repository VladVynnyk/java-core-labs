...
public class Lab6 {
    public static void main(String[] args) {
        ...
        // Deleting element from PriorityQueue for SparePart (priority_col_1) and adding new element
        priority_col_1.poll();
        SparePart newPart = new SparePart("Air Filter", 20, 10.99, 12);
        priority_col_1.add(newPart); 

        // Changing element of EnumMap for SparePartV2 (enum_col_2)
        ...
        // Deleting elements PriorityQueue for SparePart after modification
