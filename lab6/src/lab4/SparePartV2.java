...
public class SparePartV2 extends Part implements PartOperations, Comparable<SparePartV2>, Cloneable {
    ...
    public SparePartV2(String partName, int quantity, double unitPrice, int storageDuration, PartCategory category) {
    ...
    public boolean equals(Object o) {
        ...
        SparePartV2 sparePart = (SparePartV2) o;
    ...
    @Override
    public SparePartV2 clone() {
        try {
            return (SparePartV2) super.clone();
    ...
    @Override
    public int compareTo(SparePartV2 other) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Instance count: " + SparePartV2.getInstanceCount());

        Part part1 = new SparePartV2("Brake Pad", 50, 15.99, 24, PartCategory.BRAKES);
        Part part2 = new SparePartV2("Oil Filter", 30, 5.99, 18, PartCategory.ENGINE);
        Part part3 = new SparePartV2("Battery", 15, 70.0, 36, PartCategory.ELECTRICAL);
        ...
        SparePartV2 clonedPart = ((SparePartV2) part1).clone();
        System.out.println("Cloned part: " + clonedPart.toString());

        System.out.println("Comparing part1 and part3 by price: " + ((SparePartV2) part1).compareTo((SparePartV2) part3));
    }
}
